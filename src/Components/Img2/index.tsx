...
const Img2 = ({
  ...
  if (!url) return;
  // TODO:picture 和 loading='lazy'有bug，在ios上会加载2次图片png、webp
  // if (picture && window.contextBuild) {
  //     console.log('2');
  //     return (
  //         <picture>
  //             <source srcSet={avifSrc} type='image/avif' />
  //             <source srcSet={webpSrc} type='image/webp' />
  //             <img src={url} style={style} className={className} loading={loading} onError={onError} {...props} />
  //         </picture>
  //     );
  // }
  return (
